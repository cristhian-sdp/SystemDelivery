...
using SystemDelivery.Estructuras.Listas;
using System;
using System.Text;
...
namespace SystemDelivery.Estructuras.ABB
{
    ...
    internal class ArbolPedidos
    {
            ...
            Pedido pedido)
        {
            ...
            // Si el código del pedido es menor, se inserta en el subárbol izquierdo
            ...
            // Si el código del pedido es mayor, se inserta en el subárbol derecho
