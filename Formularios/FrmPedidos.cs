...
namespace SystemDelivery.Formularios
{
    public partial class FrmPedidos : Form
    {
        ...
        private void MostrarPedidos()
        {
            ...
            // Cola Prioridad
            SystemDelivery.Estructuras.ColaPrioridad.NodoPrioridad auxP = SistemaDelivery.ColaPrioridad.ObtenerFrente();
            while (auxP != null)
            {
